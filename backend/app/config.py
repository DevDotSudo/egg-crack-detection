...
class DetectionConfig:
    ...
    inner_margin_ratio: float = 0.035
    min_inner_margin: float = 3.0
    ...
    # The paper-style channel is vulnerable to long support/rim reflections.
    # Its fallback is restricted to pixels safely inside the shell boundary.
    paper_min_depth_ratio: float = 0.14
    ...
    rim_band_thickness: int = 8
    rim_overlap_reject_ratio: float = 0.58
